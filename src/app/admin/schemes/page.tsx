  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-6 py-10">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Loyalty schemes</h1>
        <Link
        ...
        <ul className="flex flex-col gap-3">
          {schemes.map((scheme) => (
            <li key={scheme.id}>
              ...
              >
                <div>
                  <p className="font-medium text-zinc-900 dark:text-zinc-100">{scheme.name}</p>
