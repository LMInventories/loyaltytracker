    ...
    <div className="flex flex-col gap-6">
      {schemes.length > 1 && (
        <div className="flex flex-col gap-1">
          <label htmlFor="scheme" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
            Scheme
          </label>
          <select
            id="scheme"
      ...
      <div className="flex flex-col items-center gap-4 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8">
        {token ? (
          <>
